...
describe('Api', () => {
  ...
  test('getLocation', async () => {
    const response = await Api.getLocation('452bf6c7-21de-4b1a-b31d-6bde4edadd40', 'conf_slug', 'mock')
  ...
  test('getAttendance', async () => {
    const response = await Api.getAttendance('725603d6-b60f-48a0-ab3c-6f9187c163c3', 'conf_slug', 'testToken', 'mock')
