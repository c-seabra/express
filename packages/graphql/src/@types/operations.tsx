...
export type Event = {
  ...
  timezone: Maybe<Scalars['String']>;
  versions: Maybe<Array<PaperTrailVersion>>;
  appearances: Maybe<AppearanceConnection>;
...
export type EventAppearancesArgs = {
  after?: Maybe<Scalars['String']>;
  before?: Maybe<Scalars['String']>;
  first?: Maybe<Scalars['Int']>;
  last?: Maybe<Scalars['Int']>;
...
export type Mutation = {
  ...
  appearanceUpdate: Maybe<AppearanceUpdatePayload>;
...
export type MutationAppearanceUpdateArgs = {
...
/** Autogenerated input type of AppearanceUpdate */
...
/** Autogenerated return type of AppearanceUpdate */
export type AppearanceUpdatePayload = {
...
/** Autogenerated input type of OrderInvoiceSend */
export type OrderInvoiceSendInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  reference: Scalars['String'];
};

/** Autogenerated return type of OrderInvoiceSend */
...
export type OrderInvoiceSendMutationVariables = Exact<{
  input: OrderInvoiceSendInput;
}>;

export type OrderInvoiceSendMutation = { __typename?: 'Mutation' } & {
  orderInvoiceSend: Maybe<
    { __typename?: 'OrderInvoiceSendPayload' } & {
      order: Maybe<
...
export type EventAppearancesQueryVariables = Exact<{
  slug?: Maybe<Scalars['String']>;
}>;

export type EventAppearancesQuery = { __typename?: 'Query' } & {
  event: Maybe<
    { __typename?: 'Event' } & {
      appearances: Maybe<
        { __typename?: 'AppearanceConnection' } & {
...
export const OrderInvoiceSendDocument: DocumentNode = {
  definitions: [
    {
      kind: 'OperationDefinition',
      name: { kind: 'Name', value: 'OrderInvoiceSend' },
      operation: 'mutation',
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'OrderInvoiceSendInput' },
            },
          },
          variable: {
            kind: 'Variable',
...
/**
 * __useOrderInvoiceSendMutation__
 *
 * To run a mutation, you first call `useOrderInvoiceSendMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useOrderInvoiceSendMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [orderInvoiceSendMutation, { data, loading, error }] = useOrderInvoiceSendMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useOrderInvoiceSendMutation(
  baseOptions?: Apollo.MutationHookOptions<
    OrderInvoiceSendMutation,
    OrderInvoiceSendMutationVariables
  >,
...
export type EventQueryResult = Apollo.QueryResult<
  ...
  EventQueryVariables
>;
export const EventAppearancesDocument: DocumentNode = {
  definitions: [
    {
      kind: 'OperationDefinition',
      name: { kind: 'Name', value: 'EventAppearances' },
      operation: 'query',
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'appearances' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
...
/**
 * __useEventAppearancesQuery__
 *
 * To run a query within a React component, call `useEventAppearancesQuery` and pass it any options that fit your needs.
 * When your component renders, `useEventAppearancesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useEventAppearancesQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useEventAppearancesQuery(
  baseOptions?: Apollo.QueryHookOptions<
    EventAppearancesQuery,
    EventAppearancesQueryVariables
  >,
) {
  return Apollo.useQuery<EventAppearancesQuery, EventAppearancesQueryVariables>(
    EventAppearancesDocument,
    baseOptions,
  );
}
export function useEventAppearancesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    EventAppearancesQuery,
    EventAppearancesQueryVariables
  >,
  ...
  return Apollo.useLazyQuery<
    EventAppearancesQuery,
    EventAppearancesQueryVariables
  >(EventAppearancesDocument, baseOptions);
}
export type EventAppearancesQueryHookResult = ReturnType<
  typeof useEventAppearancesQuery
>;
export type EventAppearancesLazyQueryHookResult = ReturnType<
  typeof useEventAppearancesLazyQuery
>;
export type EventAppearancesQueryResult = Apollo.QueryResult<
  EventAppearancesQuery,
  EventAppearancesQueryVariables
>;
